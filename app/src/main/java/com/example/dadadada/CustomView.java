...
public class CustomView extends ViewGroup {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            int viewBigMiddle = layoutHeight / 2;
            int viewSmallMiddle = view.getHeight()/2;

            int a=(viewBigMiddle-viewSmallMiddle-ySpace)/2;
            ...
            view.layout(x+xSpace, y+ySpace,x+viewWidth+xSpace, y+viewHeight+ySpace+a);
